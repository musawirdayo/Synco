  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-4 sm:px-6 md:px-12 py-8">
        ...
        >
          <span className="text-xs font-medium uppercase tracking-wider text-muted">Privacy</span>
          <h1 className="font-display text-2xl sm:text-3xl md:text-4xl mt-3 mb-5">
            Privacy policy coming soon.
          </h1>
          <p className="text-sm text-muted leading-relaxed">
            This page is a placeholder. A human-written privacy policy should be added before public
            launch.
          </p>
        </motion.div>
      </main>
